...
a_remplacer_cleaned_merged['priorite'] = pd.cut(
    a_remplacer_cleaned_merged['difficulté'], 
...
reseau_trie_final = a_remplacer_cleaned_merged.sort_values(by='difficulté', ascending=True)

reseau_trie_final = a_remplacer_cleaned_merged.sort_values(by=['priorite', 'difficulté'], ascending=[True, True])
